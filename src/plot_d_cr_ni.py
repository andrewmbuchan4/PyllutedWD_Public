...
def generate_data():
    ...
    abundances_earth, cnf_earth, ds_earth, dummy = geo_model.form_a_planet_iteratively(
        earth_pressure, earth_fO2
    )
    print("Earth numbers")
    ...
    for run_name, T in T_dict.items():
        ...
        for P in p_range:
            abundances, cnf, Ds, dummy = geo_model.form_a_planet_iteratively(
                P, earth_fO2, T
            )
    ...
    for P in p_range:
        ...
        for T in t_range:
            ...
            try:
                ...
                kd_ni = Ds[ci.Element.Ni] / (Ds[ci.Element.Fe] ** (ni_valence / 2))
                # ^ This should be independent of fO2!
                kd_deviation_ni_array[t_index][p_index] = min(
                    abs(np.log10(kd_ni) - log_kd_ni_earth) / log_kd_ni_earth, 1
                )
                ...
                "d_cr_3d": {
                    ...
                    "series": {
                        "3dscatter": {
                            ...
                            "cbar_label": r"$D_{Cr}$",
                            "levels": np.linspace(
                                d_cr_array.min(), d_cr_array.max(), 20
                            ),
                ...
                "d_ni_3d": {
                    ...
                    "series": {
                        "3dscatter": {
                            ...
                            # 'z_scale': 'log',
                            "levels": np.linspace(
                                np.log10(d_ni_array.min()),
                                np.log10(d_ni_array.max()),
                                20,
                            ),
                ...
                "d_mult": {
                    ...
                    "series": {
                        "Ni": {
                            ...
                            "x_data": p_data["run4"],
                            "y_data": [
                                p / ds_earth[ci.Element.Ni] for p in ni_data["run4"]
                            ],
                            "line_type": "r-",
                            "line_linewidth": 1,
                            "legend": True,
                        ...
                        "Cr": {
                            ...
                            "x_data": p_data["run4"],
                            "y_data": [
                                p / ds_earth[ci.Element.Cr] for p in cr_data["run4"]
                            ],
                            "line_type": "b-",
                            "line_linewidth": 1,
                            "legend": True,
                        ...
                        "Fe": {
                            ...
                            "x_data": p_data["run4"],
                            "y_data": [
                                p / ds_earth[ci.Element.Fe] for p in fe_data["run4"]
                            ],
                            "line_type": "k-",
                            "line_linewidth": 1,
                            "legend": True,
                        ...
                        "C": {
                            ...
                            "x_data": p_data["run4"],
                            "y_data": [
                                p / ds_earth[ci.Element.C] for p in c_data["run4"]
                            ],
                            "line_type": "c-",
                            "line_linewidth": 1,
                            "legend": True,
                        ...
                        "O": {
                            ...
                            "x_data": p_data["run4"],
                            "y_data": [
                                p / ds_earth[ci.Element.O] for p in o_data["run4"]
                            ],
                            "line_type": "y-",
                            "line_linewidth": 1,
                            "legend": True,
                        ...
                        "Si": {
                            ...
                            "x_data": p_data["run4"],
                            "y_data": [
                                p / ds_earth[ci.Element.Si] for p in si_data["run4"]
                            ],
                            "line_type": "g-",
                            "line_linewidth": 1,
                            "legend": True,
                ...
                "d_mult": {
                    ...
                    "series": {
                        "Ni": {
                            ...
                            "x_data": fo2_range,
                            "y_data": [
                                p / ds_earth[ci.Element.Ni] for p in d_ni_fo2_array
                            ],
                            "line_type": "r-",
                            "line_linewidth": 1,
                            "legend": True,
                        ...
                        "Cr": {
                            ...
                            "x_data": fo2_range,
                            "y_data": [
                                p / ds_earth[ci.Element.Cr] for p in d_cr_fo2_array
                            ],
                            "line_type": "b-",
                            "line_linewidth": 1,
                            "legend": True,
                        ...
                        "Fe": {
                            ...
                            "x_data": fo2_range,
                            "y_data": [
                                p / ds_earth[ci.Element.Fe] for p in d_fe_fo2_array
                            ],
                            "line_type": "k-",
                            "line_linewidth": 1,
                            "legend": True,
                        ...
                        "C": {
                            ...
                            "x_data": fo2_range,
                            "y_data": [
                                p / ds_earth[ci.Element.C] for p in d_c_fo2_array
                            ],
                            "line_type": "c-",
                            "line_linewidth": 1,
                            "legend": True,
                        ...
                        "O": {
                            ...
                            "x_data": fo2_range,
                            "y_data": [
                                p / ds_earth[ci.Element.O] for p in d_o_fo2_array
                            ],
                            "line_type": "y-",
                            "line_linewidth": 1,
                            "legend": True,
                        ...
                        "Si": {
                            ...
                            "x_data": fo2_range,
                            "y_data": [
                                p / ds_earth[ci.Element.Si] for p in d_si_fo2_array
                            ],
                            "line_type": "g-",
                            "line_linewidth": 1,
                            "legend": True,
                ...
                "d_si_3d": {
                    ...
                    "series": {
                        "3dscatter": {
                            ...
                            #'z_scale': 'log',
                            "levels": np.linspace(
                                np.log10(d_si_array.min()),
                                np.log10(d_si_array.max()),
                                20,
                            ),
                ...
                "d_ni_3d": {
                    ...
                    "series": {
                        "3dscatter": {
                            ...
                            "colour_map_max": np.log10(d_ni_array.min())
                            + (np.log10(d_si_array.max()) - np.log10(d_si_array.min())),
                        },
                        "Peridotite liquidus": {
                            "type": dp.PlotType.function_2d,
                            "function": geo_model.pamela.peridotite_liquidus,
