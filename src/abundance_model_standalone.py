...
def plot_element_dropout(stellar_metallicity_index, z_formation, t_formation=1.5, elements_to_plot=ci.usual_elements):
    ...
    graph_fac.plot_element_dropout(d_formation_vals, T_vals, element_abundance_vals, z_formation)
    graph_fac.plot_element_dropout_ratio(d_formation_vals, T_vals, element_abundance_vals, ci.Element.Ca, ci.Element.Mg, z_formation)
    graph_fac.plot_element_dropout_ratio(d_formation_vals, T_vals, element_abundance_vals, ci.Element.Ti, ci.Element.Mg, z_formation)
    graph_fac.plot_element_dropout_ratio(d_formation_vals, T_vals, element_abundance_vals, ci.Element.Ca, ci.Element.Ti, z_formation)
...
def main():
    ...
    output_el_el_values(ci.Element.N, ci.Element.Si, z_formation, t_formation, stellar_metallicity_index)
