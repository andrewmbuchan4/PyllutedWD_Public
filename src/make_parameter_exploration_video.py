...
video_configurations = {
    "volatile_depletion": {
        ...
        "leg_descriptors": [("log(distance)", 2), ("log(distance)", 2)],
        "list_of_coordinates": [
            # [
            #     fe_star,
    ...
    "differentiation": {
        ...
        "leg_descriptors": [("core fraction", 6)],
        "list_of_coordinates": [
            # [
            #     fe_star,
            #     t_sinceaccretion (Myr),
    ...
    "GD362": {
        ...
        "logg": 7.95,
        "wd_abundances": {
            ci.Element.Al: wd.WhiteDwarfDataPoint(
                wd.WhiteDwarfDataPointType.measurement, -6.4, 0.2
            ),
            ci.Element.Ti: wd.WhiteDwarfDataPoint(
                wd.WhiteDwarfDataPointType.measurement, -7.95, 0.1
            ),
            ci.Element.Ca: wd.WhiteDwarfDataPoint(
                wd.WhiteDwarfDataPointType.measurement, -6.24, 0.1
            ),
            ci.Element.Ni: wd.WhiteDwarfDataPoint(
                wd.WhiteDwarfDataPointType.measurement, -7.07, 0.15
            ),
            ci.Element.Fe: wd.WhiteDwarfDataPoint(
                wd.WhiteDwarfDataPointType.measurement, -5.65, 0.1
            ),
            ci.Element.Cr: wd.WhiteDwarfDataPoint(
                wd.WhiteDwarfDataPointType.measurement, -7.41, 0.1
            ),
            ci.Element.Mg: wd.WhiteDwarfDataPoint(
                wd.WhiteDwarfDataPointType.measurement, -5.98, 0.25
            ),
            ci.Element.Si: wd.WhiteDwarfDataPoint(
                wd.WhiteDwarfDataPointType.measurement, -5.84, 0.3
            ),
            ci.Element.Na: wd.WhiteDwarfDataPoint(
                wd.WhiteDwarfDataPointType.measurement, -7.79, 0.2
            ),
            ci.Element.O: wd.WhiteDwarfDataPoint(
                wd.WhiteDwarfDataPointType.upper_bound, -5.14, None, False
            ),
            ci.Element.N: wd.WhiteDwarfDataPoint(
                wd.WhiteDwarfDataPointType.upper_bound, -4.14, None, False
            ),
        },
        "leg_descriptors": [
            ("log(distance)", 2),
    ...
    "WD0059+257": {
        ...
        "wd_abundances": {
            ci.Element.Al: wd.WhiteDwarfDataPoint(
                wd.WhiteDwarfDataPointType.upper_bound, -6.97
            ),
            ci.Element.Ca: wd.WhiteDwarfDataPoint(
                wd.WhiteDwarfDataPointType.measurement, -6.71, 0.19
            ),
            ci.Element.Ni: wd.WhiteDwarfDataPoint(
                wd.WhiteDwarfDataPointType.measurement, -6.8, 0.24
            ),
            ci.Element.Fe: wd.WhiteDwarfDataPoint(
                wd.WhiteDwarfDataPointType.measurement, -5.54, 0.16
            ),
            ci.Element.Cr: wd.WhiteDwarfDataPoint(
                wd.WhiteDwarfDataPointType.upper_bound, -6.59
            ),
            ci.Element.Mg: wd.WhiteDwarfDataPoint(
                wd.WhiteDwarfDataPointType.measurement, -5.84, 0.14
            ),
            ci.Element.Si: wd.WhiteDwarfDataPoint(
                wd.WhiteDwarfDataPointType.measurement, -6.26, 0.24
            ),
            ci.Element.Na: wd.WhiteDwarfDataPoint(
                wd.WhiteDwarfDataPointType.measurement, -7.79, 0.2
            ),
            ci.Element.O: wd.WhiteDwarfDataPoint(
                wd.WhiteDwarfDataPointType.measurement, -5.72, 0.14
            ),
        },
        "leg_descriptors": [
            ("core fraction", 6),
    ...
    "J1227GR": {
        ...
        "wd_abundances": {
            ci.Element.Al: wd.WhiteDwarfDataPoint(
                wd.WhiteDwarfDataPointType.upper_bound, -7
            ),
            ci.Element.Ti: wd.WhiteDwarfDataPoint(
                wd.WhiteDwarfDataPointType.measurement, -9.7, 0.3
            ),
            ci.Element.Ca: wd.WhiteDwarfDataPoint(
                wd.WhiteDwarfDataPointType.measurement, -8.7, 0.2
            ),
            ci.Element.Ni: wd.WhiteDwarfDataPoint(
                wd.WhiteDwarfDataPointType.measurement, -8.9, 0.2
            ),
            ci.Element.Fe: wd.WhiteDwarfDataPoint(
                wd.WhiteDwarfDataPointType.measurement, -7.5, 0.2
            ),
            ci.Element.Cr: wd.WhiteDwarfDataPoint(
                wd.WhiteDwarfDataPointType.upper_bound, -9
            ),
            ci.Element.Mg: wd.WhiteDwarfDataPoint(
                wd.WhiteDwarfDataPointType.measurement, -7.3, 0.2
            ),
            ci.Element.Si: wd.WhiteDwarfDataPoint(
                wd.WhiteDwarfDataPointType.upper_bound, -7.1
            ),
            ci.Element.Na: wd.WhiteDwarfDataPoint(
                wd.WhiteDwarfDataPointType.measurement, -8.3, 0.2
            ),
            ci.Element.O: wd.WhiteDwarfDataPoint(
                wd.WhiteDwarfDataPointType.upper_bound, -4
            ),
        },
        "leg_descriptors": [("formdist", 2), ("formdist", 2)],
        "list_of_coordinates": [
            # [
            #     fe_star,
            #     t_sinceaccretion (Myr),
...
def interpolate_between_coords(coord1, coord2, interpolation_fraction):
    ...
    for i, entry1 in enumerate(coord1):
        entry2 = coord2[i]
        try:
            interpolated_entry = (entry1 * (1 - interpolation_fraction)) + (
                entry2 * interpolation_fraction
            )
...
def produce_pngs(
    ...
    wd_property_data_raw1 = {
        ...
        mp.WDParameter.temperature: wd.WhiteDwarfDataPoint(
            wd.WhiteDwarfDataPointType.measurement, Teff, 0
        ),
        mp.WDParameter.logg: wd.WhiteDwarfDataPoint(
            wd.WhiteDwarfDataPointType.measurement, logg, 0
        ),
    }
    ...
    M_X = np.array(
        [
            (10 ** sa.solar_ratiod_to_H[el]) * (ci.get_element_mass(el))
            for el in elements_to_plot
        ]
    )
    tau_X = white_dwarf.get_timescales_as_array(timescale_type, elements_to_plot)
    # tau_X = np.array(  # for testing. should remove differential sinking
    #     [
    #         5000000,
    #         5000000,
    #         5000000,
    ...
    for coord_index, coord in enumerate(list_of_coordinates):
        ...
        interpolation_steps_to_use = (
            interpolation_steps[leg] - 1 if leg == 0 else interpolation_steps[leg]
        )
...
def main():
    ...
    print(
        "Now run this in the output directory ("
