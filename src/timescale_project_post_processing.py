...
def output_rows(list_of_rows):
    with open('timescale_project_postprocess.csv', 'w', newline='', encoding='utf-8') as f:
        ...
        to_write.writerow(['Sigma Overturned','Sigma Unoverturned','Delta Time 1 (Myr)','tau Mg 1 (yr)','D 1','Delta Time 2 (Myr)','tau Mg 2 (yr)','D 2'])
