...
def fznd(d_formation, z_formation):
    # In principle, this function is not a function of d_formation, it's just finding
    # the appropriate weights of bins of a gaussian distribution with width z_formation,
    # where the bins are centred on the same centre as the gaussian and go 3AU either
    # side
    ...
    # In principle, the next 3 variables should be calculated dynamically, but for now
    # I'm just fixing them for performance testing purposes
