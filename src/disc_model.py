...
def S_disc(t_formation):
    ...
    Tvis = (
        (((27 * k0) / (64 * sigma)) ** (1 / 3))
        * (((alpha * gamma * k) / (mu * mH)) ** (1 / 3))
        * (((7 * sun) / (100 * 3.14 * (s0**2))) ** (2 / 3))
        * (((G * sun) / (s0**3)) ** (1 / 6))
        * (Mstar ** (5 / 6))
    )
    Trad = (
    ...
    if 0 <= t_formation * (3.1536 * 10**13) <= t1:
        ...
        s = (
            s0
            * ((Tvis / Trad) ** (42 / 73))
            * ((1 + ((t_formation * (3.1536 * 10**13) - t1) * invtrad)) ** (14 / 13))
        )
    else:
        s = s0
    ...
    if (
        ...
        < (
            (
                (s0)
                * ((Se / Svis) ** (95 / 63))
                * ((1 + (t_formation * (3.1536 * 10**13) * (invtvis))) ** (-19 / 36))
            )
            / (1.496 * 10**11)
        )
    ):
        T = (
            (Tvis ** (5 / 19))
            * (Te ** (14 / 19))
            * ((((1.496 * 10**11) * d_formation) / s0) ** (-9 / 38))
            * ((1 + (t_formation * (3.1536 * 10**13) * (invtvis))) ** (-1 / 8))
        )
    elif (
        (
            (
        ...
        < (
            (
                (s0)
                * ((Srad / Svis) ** (70 / 33))
                * ((1 + (t_formation * (3.1536 * 10**13) * (invtvis))) ** (-133 / 132))
            )
            / (1.496 * 10**11)
        )
    ):
        T = (
            Tvis
            * ((((1.496 * 10**11) * d_formation) / s0) ** (-9 / 10))
            * ((1 + ((t_formation * (3.1536 * 10**13)) / (tvis))) ** (-19 / 40))
        )
    elif d_formation > (
        (
            (s0)
...
def main():
    print(T_disc(0.0955635, 1.5))
    print(T_disc(0.0955, 1.5))
    print(T_disc(0.0956, 1.5))
    print(T_disc(0.1, 1.5))
    print(T_disc(10, 1.5))
